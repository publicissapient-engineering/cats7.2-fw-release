...
<html lang="en">
   ...
   <body style="background: rgb(242, 246, 253,1);">
      <#if startTime?? && endTimeftl?? && projectName??>
      ...
      <div class="row myRow" style="margin-right:0px;margin-left:0px;display:table;">
         <div class="column">
            ...
            <div class="duration">Total time taken ${executionTime}</div>
         </div>
         <div class="header">
               ...
               <div>
                  ...
                  <div class="rowQuadrant" id="rowQuadrantSuite" style="border-bottom:10px solid white;">
                     <div class="columnQuadrant" id="columnQuadrantSuite" style="width: 185px;height: 130px;cursor:pointer;margin-right: 8px;margin-left: -15px;border-top:10px solid #2fa7a3;border-left:10px solid #3d807e;border-width: 30px;" onclick="init('suite')">
                        <p style="color: white;font-weight: bolder;margin-top: 20px;margin-left: -180px;transform: rotate(-90deg);text-align: center;">SUITES</p>
                  ...
                  <div class="rowQuadrant">
                     <div class="columnQuadrant" id="columnQuadrantCase" style="width: 185px;height: 130px;cursor:pointer;margin-right: 8px;margin-left: -15px;border-bottom:10px solid #13dcd6;border-left:10px solid #3d807e;border-width: 30px;" onclick="init('case')">
                        ...
                        <p  style="text-align: center;margin-top: -5px;color: white;font-weight:bolder">TESTCASE</p>
                     ...
                     <div class="columnQuadrant" id="columnQuadrantStep" onclick="init('step')" style="width: 185px;height: 130px;cursor:pointer;border-bottom:10px solid #13dcd6;border-right:10px solid #f2f6fd;border-right:10px solid #1cbdb8;border-width: 30px;">
                        ...
                        <p id="stepTotal" style="text-align: center;margin-top: -5px;color: white;"></p>
                        <p style="color: white;font-weight: bolder;text-align: center;margin-top: -75px;margin-right: -185px;transform: rotate(91deg);">TESTSTEP</p>
                     </div>
                  </div>
               </div>
            </td>
         ...
         <table  cellpadding="10" style="width:100%">
            <thead>
               <tr style="background-color:#3c7aa9;color:white;">
                  <th class="columnHeader" colspan="4" style="text-align:center;">Suites</th>
                  <th class="columnHeader" colspan="4" style="text-align:center;">Scenarios</th>
                  <th class="columnHeader" colspan="6" style="text-align:center;">${EXECUTIVE_REPORT_BASED_ON?capitalize}</th>
               </tr>
            ...
            <#assign resultColor='color_amber'>
               ...
               <tr style="background-color:#faffdc">
                  ...
                  <#if skipped==true && system.scenarioSkipCount gt 0>
                  <td class="color_skip"><a href="${system.testSuite}-exec-report.html?type=listVType"><div style="height:100%;width:100%;color:white;font-size: 18px;">${system.testSuite}</div></a></td>
                  <#else>
                  <td class="${resultColor}"><a href="${system.testSuite}-exec-report.html?type=listVType"><div style="height:100%;width:100%;color:white;font-size: 18px;">${system.testSuite}</div></a></td>
                  </#if>
            ...
            <div class="modal-dialog custom-dialog" style="width:80%;height:auto; max-height:70%">
               <div class="modal-content" >
                  <div class="modal-header" style="border:0px solid white;">
                     <h4 class="modal-title" style="text-align:center;font-weight:bolder;">Suite Status</h4>
                        ...
                        <ul class="nav nav-pills" role="tablist" style="width: 100%;margin-left: 33%;">
                           <li role="presentation" class="dropdown">
                              ...
                              <ul class="dropdown-menu" id="menu2" aria-labelledby="drop5">
                                 ...
                                 <li id="caseCategory" onclick="categoryFunction('barCase')"><a href="#">TEST CASE</a></li>
                                 <!--<li role="separator" class="divider"></li>-->
                                 <li id="stepCategory" onclick="categoryFunction('barStep')"><a href="#">TEST STEP</a></li>
                              </ul>
                           </li>
                           <li>
                              <ul>
      ...
      <script>
         ...
         var PassThresholdPercentage=${PASS_PERCENTAGE_THRESHOLD};
         var FailThresholdPercentage=${FAIL_PERCENTAGE_THRESHOLD};
      ...
      <script type="module">
         ...
         const path = g.append("g")
          ...
          .attr("fill", function(d) { 
                  						...
                  						if(d.depth==1){
                  						if(d.data.colorForSuiteTerminated){
                  						return '#0e69ae';
                  						}
                  						else{
                  						if(d.data.SKIPPED > 0){
                  						...
                  						if(d.depth==2){
                  						if(d.data.colorLeadsToScenarioTerminated==1){
                  						return '#1388df';
                  						}
                  						else{
                  						if(d.data.SKIPPED > 0){
                  						...
                  						if(d.depth==3){
                  						if(d.data.colorLeadsToTestCaseTerminated==1){
                  						return '#56aff1';
                  						}
                  						else{
                  						if(d.data.SKIPPED > 0){
                  ...
                  <div class="table-responsive" style="margin-top: -15px;">
                     <table class="table table-bordered" id="indextable">
                        <thead>
                           ...
                           <tr style="background-color:#99cccc;color:#1e2c42">
                              <th class="dataAlign textCenterAlign" onclick="SortTable(0,'T')" style="cursor:pointer">Name</th>
                              <th class="dataAlign textCenterAlign" onclick="SortTable(1,'T')" style="cursor:pointer">Release</th>
                              <th class="dataAlign textCenterAlign" onclick="SortTable(2,'T')" style="cursor:pointer">Channel</th>
                              <th class="dataAlign textCenterAlign" onclick="SortTable(3,'T')" style="cursor:pointer">Browser</th>
                              <th class="dataAlign textCenterAlign" onclick="SortTable(4,'N')" style="cursor:pointer">Passed</th>
                              <th class="dataAlign textCenterAlign" onclick="SortTable(5,'N')" style="cursor:pointer">Failed</th>
                              <th class="dataAlign textCenterAlign" onclick="SortTable(6,'N')" style="cursor:pointer">Skipped</th>
                              <th class="dataAlign textCenterAlign" onclick="SortTable(7,'N')" style="cursor:pointer">Total</th>
                              <th class="dataAlign textCenterAlign" onclick="SortTable(8,'N')" style="cursor:pointer">Passed</th>
                              <th class="dataAlign textCenterAlign" onclick="SortTable(9,'N')" style="cursor:pointer">Failed</th>
                              <th class="dataAlign textCenterAlign" onclick="SortTable(10,'N')" style="cursor:pointer">Skipped</th>
                              <th class="dataAlign textCenterAlign" onclick="SortTable(11,'N')" style="cursor:pointer">Total</th>
                              <th class="dataAlign textCenterAlign" onclick="SortTable(12,'N')" style="cursor:pointer">Execution</th>
                              <th class="dataAlign textCenterAlign" onclick="SortTable(13,'D','mdy')" style="cursor:pointer">Duration</th>
                           </tr>
                        </thead>
                        <tbody>
                        <#assign overallValue=0>
                     ...
                     <table class="table table-hover text-center" style="height:360px;">
                        <thead>
                           ...
                           <th class="${resultColor} headerAlignment" colspan="2">
                              ...
                              <a href="${system.testSuite}-exec-report.html?type=boxVType">
                                 <div style="color:white;text-align:center;font-size:20px;line-height: 1;display: table;white-space: pre-wrap;white-space: -moz-pre-wrap;white-space: -pre-wrap;white-space: -o-pre-wrap;word-wrap: break-word;word-break: break-all;">${system.testSuite}</div>
                              </a>
                           </th>
                        </thead>
                        <tbody>
                           ...
                           <tr>
                              ...
                              <#assign executionPercentageBox=system.executionPercentage>
                              <#assign percentageValue=executionPercentageBox?replace("%","")>
                              <#if percentageValue?number lt 100>
                              <td style="color:#56aff1">${executionPercentageBox}</td>
                              <#else>
      ...
      <div class="footer-bottom ${result}">
         ...
         <div class="col-sm-4 ">
            ...
            <#assign overallPercentage=overallValue/totalValues>
            <span style="float:right;font-size:22px;" id="makeTop">${EXECUTIVE_REPORT_BASED_ON} Execution Rate :${overallPercentage?string["0.##"]}%</span>
         </div>
      </div>
      <script>
